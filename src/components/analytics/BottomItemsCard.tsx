...
export function BottomItemsCard({ items }: { items: RankedMenuItem[] }) {
    return (
        <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
            <div className="mb-5">
                ...
                <p className="mt-1 text-sm text-gray-500">
                    Lowest revenue items in the selected window.
                </p>
            </div>

            {items.length === 0 ? (
                <p className="text-sm text-gray-500">Not enough sales data yet.</p>
            ) : (
